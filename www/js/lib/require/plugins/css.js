...
define("css",['lib/require/plugins/normalize'], function(normalize) {
  ...
  // the current /home/christus/TOMCAT7/apache-tomcat-7.0.35/webapps/www/js/css.jslayer buffer items (from addBuffer)
  var curBuffer = [];
